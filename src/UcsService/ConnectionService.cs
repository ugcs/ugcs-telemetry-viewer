...
namespace UGCS.UcsServices
{
    public sealed class ConnectionService : IDisposable
    {
        ...
        private readonly log4net.ILog _log = log4net.LogManager.GetLogger(typeof(ConnectionService));
            ...
            where TResponse : IExtensible
        {
            ...
            if (execution.Exception == null && execution.Value == null)
                throw new InvalidOperationException("Server returned an empty response and no errors, that's unexpected.");
        ...
        {
            return ex is ServerException serverEx &&
                serverEx.Error != null &&
                serverEx.Error.ErrorCode == LICENSE_CONSTRAINT_ERROR;
        }
